...
{
    public static class IndicatorMA
    {
        ...
        public static async Task<List<decimal>> KAMA(List<int> data, int erPeriod, decimal fastSC, decimal slowSC)
        {
            List<decimal> DecList = new List<decimal>();
            data.ForEach(item => DecList.Add((decimal)item));
            List<decimal> Result = await KAMA(data, erPeriod, fastSC, slowSC);
            return Result;
        }

        public static async Task<List<decimal>> KAMA(List<float> data, int erPeriod, decimal fastSC, decimal slowSC)
        {
            List<decimal> DecList = new List<decimal>();
            data.ForEach(item => DecList.Add((decimal)item));
            List<decimal> Result = await KAMA(data, erPeriod, fastSC, slowSC);
        ...
        public static async Task<List<decimal>> KAMA(List<double> data, int erPeriod, decimal fastSC, decimal slowSC)
        {
            List<decimal> DecList = new List<decimal>();
            data.ForEach(item => DecList.Add((decimal)item));
            List<decimal> Result = await KAMA(data, erPeriod, fastSC, slowSC);
